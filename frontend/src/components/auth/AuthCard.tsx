...
export function AuthCard({ children, title, subtitle }: AuthCardProps) {
  return (
    <div className="w-full max-w-md overflow-hidden rounded-soft-lg border border-zinc-200/80 bg-white/70 p-8 shadow-soft-xl backdrop-blur-xl dark:border-zinc-800/60 dark:bg-zinc-900/70 sm:p-10">
