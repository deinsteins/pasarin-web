...
func main() {
	...
	app.Put("/api/products/:id", middleware.JWTAuthMiddleware(), productHandler.Update)
	app.Delete("/api/products/:id", middleware.JWTAuthMiddleware(), productHandler.Delete)
